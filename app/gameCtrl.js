        ...
        if (json) {
          ...
          if (entries) {
            result = entries.map(function(entry) {
              ...
              var detailsCreated = matchDetails['ns1:DetailsCreated']
              if (detailsCreated != 'false') {
                ...
                homePlayers = homePlayers.map(function(homePlayer) {
                  return {
                    'uidx': homePlayer['ns1:UniqueIndex'],
                ...
                awayPlayers = awayPlayers.map(function(awayPlayer) {
                  return {
                    'uidx': awayPlayer['ns1:UniqueIndex'],
                ...
                matches = individualMatchResults.map(function(individualMatchResult) {
                  return {
                    'position': individualMatchResult['ns1:Position'],
